require(["esri/config", "esri/Map", "esri/views/MapView", "esri/core/urlUtils","esri/layers/CSVLayer","dojo/domReady!"
        ], 
      
        function(esriConfig, Map, MapView, urlUtils, CSVLayer){
